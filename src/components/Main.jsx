...
export default function Main() {
        ...
        return (
            <>
                <div>
                    ...
                    <button onClick={() => deleteIngredient(ingredient)}>X</button>
                </div>
            </>
    ...
    return (
        <main>
            ...
            {ingredients.length > 0 && <section className="ingredients-on-hand">
            ...
            {recipeShown && <section>
                <article className="suggested-recipe-container" aria-live="polite">
                    <h2 className="chef-recommend-title">Chef Claude Recommends:</h2>
